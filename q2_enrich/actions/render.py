...
from q2_enrich.format_types import RevealSectionsDirFmt, RevealSectionsFormat
...
ASSETS = pkg_resources.resource_filename('q2_enrich.actions', 'assets')

# Set up a template enviornment with the same "style" of module pathing.
J_ENV = jinja2.Environment(
    loader=jinja2.PackageLoader('q2_enrich.actions', 'jinja2')
)
